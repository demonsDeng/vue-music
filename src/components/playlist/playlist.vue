<template>
  <transition name="list-fade">
    <div class="playlist" v-show="showFlag" @click.stop="hide">
      <div class="list-wrapper" @click.stop>
        <div class="list-header">
          <h1 class="title">
            ...
            <span class="clear" @click="isClear"><i class="icon-clear"></i></span>
          </h1>
        </div>
        <scroll ref="listScroll" class="list-content" :data="sequenceList">
          <ul>
            <li ref="listItem" v-for="(item,index) in sequenceList" class="item"  @click="selectItem(item, index)">
      ...
      <confirm @confirm="clearAllList" ref="confirm" text="是否清除播放列表" confirmBtnText="清除"></confirm>
    </div>
  </transition>
</template>
    ...
    methods: {
      show() {
        ...
        setTimeout(() => {
          ...
          this.scrollToTarget(this.currentSong)
        }, 20)
      },
      hide() {
        this.showFlag = false
